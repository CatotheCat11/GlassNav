...
public class OsmMvtTileSource extends UrlTileSource {

    private static final String DEFAULT_URL = "https://tiles.openstreetmap.us/vector/openmaptiles";
    ...
    public static class Builder<T extends Builder<T>> extends UrlTileSource.Builder<T> {
        ...
        @Override
        public OsmMvtTileSource build() {
            return new OsmMvtTileSource(this);
        }
    }
    ...
    public OsmMvtTileSource(Builder<?> builder) {
        super(builder);
        this.locale = builder.locale;
    }

    public OsmMvtTileSource() {
        this(builder());
    }

    public OsmMvtTileSource(String urlString) {
