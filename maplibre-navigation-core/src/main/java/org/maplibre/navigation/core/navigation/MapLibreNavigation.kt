...
open class MapLibreNavigation @JvmOverloads constructor(
    ...
    fun addMilestone(milestone: Milestone) {
        ...
        if (!milestoneAdded) {
            Log.w("MapLibreNavigation", "Milestone has already been added to the stack.")
        }
    }
    ...
    fun addMilestones(milestones: List<Milestone>) {
        ...
        if (!milestonesAdded) {
            Log.w("MapLibreNavigation", "These milestones have already been added to the stack.")
        }
    }
    ...
    fun removeMilestone(milestone: Milestone?) {
        if (milestone == null) {
            ...
            Log.w("MapLibreNavigation", "Milestone attempting to remove does not exist in stack.")
        }
    }
    ...
    fun removeMilestone(milestoneIdentifier: Int) {
        milestones.firstOrNull { m -> m.identifier == milestoneIdentifier }
            ...
            ?: run { Log.w("MapLibreNavigation", "No milestone found with the specified identifier.") }
    }
    ...
    fun startNavigation(directionsRoute: DirectionsRoute) {
        ...
        Log.d("MapLibreNavigation", "MapLibreNavigation startNavigation called." )
     ...
     */
    fun stopNavigation() {
        Log.d("MapLibreNavigation", "MapLibreNavigation stopNavigation called" )
    ...
    fun setIndex(legIndex: Int, stepIndex: Int) {
        ...
        Log.d("MapLibreNavigation", "Manual waypoint update: advancing to leg $legIndex, step $stepIndex" )
